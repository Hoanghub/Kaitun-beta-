...
local ToggleFastAttackDelay = Tabs.Main:AddToggle("ToggleFastAttackDelay", {Title = " FastAttack Delay", Default = false })
    Toggle FastAttack Delay:OnChanged(function(Value)
        _G.FastAttackDelay = Value
    end)
    Options.ToggleFastAttack Delay:SetValue(false)
    local AttackList = {"0", "0.1", "0.175", "0.2", "0.25", "0.3", "0.35", "0.4", "0.45", "0.5", "0.55", "0.6", "0.65", "0.7", "0.75", "0.8", "0.85", "0.9", "0.95", "0.1"}
M:AddDropdown({
	Name = "FastAttack Delay Delay",
	Default = "0.5",
	Options = AttackList,
